...
export function ProfessorManagement({ centerId }: ProfessorManagementProps) {
    ...
    const handleGenerateLink = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("/api/professors/invite", {
                method: "POST",
            ...
            if (res.ok && data.token) {
                ...
                setInvitationLink(`${origin}/register-professor?token=${data.token}`);
            } else {
    ...
    return (
        <div className="space-y-6">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="w-full max-w-lg rounded-xl bg-card p-6 shadow-xl ring-1 ring-border/50 relative">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                                Crea un enlace temporal para que los profesores se registren en tu centro.
                            </p>
                        </div>
                        ...
                        {!invitationLink ? (
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Copia este enlace y compártelo con tus profesores. Podrán registrarse y tendrán acceso a Simcor inmediatamente.
                                </p>
            ...
            {/* Modal de Inscripción de Profesor */}
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="w-full max-w-lg rounded-xl bg-card p-6 shadow-xl ring-1 ring-border/50 relative">
                        <button
